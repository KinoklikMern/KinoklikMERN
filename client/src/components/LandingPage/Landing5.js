      ...
      <div className=' tw-flex tw-flex-col tw-items-center tw-gap-20'>
        <div className='tw-flex tw-w-full tw-flex-col tw-items-center tw-gap-5 tw-px-5 md:tw-flex-row md:tw-px-10'>
          ...
          <div className='tw-rounded-xl tw-bg-[#3f2556] tw-p-5 md:tw-w-2/4'>
            ...
            {t("Protect your film's Intelectual Property")} (IP) {t("by blurring out any")}
        ...
        <div className='tw-flex tw-w-full tw-flex-col-reverse tw-items-center tw-gap-5 tw-px-5 md:tw-flex-row md:tw-px-10'>
          <div className='tw-rounded-xl tw-bg-[#3f2556] tw-p-5 md:tw-w-2/4'>
            <p className='tw-text-center tw-font-semibold tw-text-white md:tw-text-2xl'>
            {t("Add unlimited Actors information to your film EPK in the Cast &")}
              {t(" Crew section.")}
            </p>
          </div>
        ...
        <div className='tw-flex tw-w-full tw-flex-col-reverse tw-items-center tw-gap-5 tw-px-5 md:tw-flex-row md:tw-px-10'>
          <div className='tw-rounded-xl tw-bg-[#3f2556] tw-p-5 md:tw-w-2/4'>
            <p className='tw-text-center tw-font-semibold tw-text-white md:tw-text-2xl'>
            {t("Control all information you display about your film directly from")}
        ...
        <div className='tw-flex tw-w-full tw-flex-col tw-items-center tw-gap-5 tw-px-5 md:tw-flex-row md:tw-px-10'>
          ...
          <div className='tw-rounded-xl tw-bg-[#3f2556] tw-p-5 md:tw-w-2/4'>
            <p className='tw-text-center tw-font-semibold tw-text-white md:tw-text-2xl'>
            {t("Take advantage of the views and traffic to tell people what you")}
              {t(" need for your film! You never know who has access to that red")}
        ...
        <div className='tw-flex tw-w-full tw-flex-col-reverse tw-items-center tw-gap-5 tw-px-5 md:tw-flex-row md:tw-px-10'>
          <div className='tw-rounded-xl tw-bg-[#3f2556] tw-p-5 md:tw-w-2/4'>
            <p className='tw-text-center tw-font-semibold tw-text-white md:tw-text-2xl'>
            {t("Discover up-and-coming Actors eager to join your film project and")}
              {t(" add them to your EPK. Follow, Star and Recommend Actors to other")}
