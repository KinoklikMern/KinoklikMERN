...
const UniquesPreview = () => {
  ...
  return (
    <div class="container">
      ...
      <div>
        {uniqueData.unique1_title ||
        uniqueData.unique1_description ||
        uniqueData.unique1_poster_url ? (
          <>
            <div class="unique-container">
              <p></p>
              <img
                src={uniqueData.unique1_poster_url}
                class="img-fluid"
                alt=""
              />
      ...
      <div>
        {uniqueData.unique2_title ||
        uniqueData.unique2_description ||
        uniqueData.unique2_poster_url ? (
          <>
            <div class="unique-container">
              <p></p>
              <img
                src={uniqueData.unique2_poster_url}
                class="img-fluid"
                alt=""
              />
