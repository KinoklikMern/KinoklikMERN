    ...
    <div className={style.container}>
      <div className={style.detailContainer}>
        ...
        <div className={style.el2}>
          <p>Directed by: {detailsFile.detailsFile.director}</p>

          <p>Produced by: {detailsFile.detailsFile.producer}</p>

          <p>Writer: {detailsFile.detailsFile.writer}</p>

          <p>Cinematographer: {detailsFile.detailsFile.cinematographer}</p>

          <p>Editor: {detailsFile.detailsFile.editor}</p>

          <p>Sound: {detailsFile.detailsFile.sound}</p>

          <p>Studio: {detailsFile.detailsFile.productionCo}</p>

          <p>Distributed by: {detailsFile.detailsFile.distributionCo}</p>
        </div>
