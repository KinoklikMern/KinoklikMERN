          ...
          >
            ...
            {/*</h5>*/}
              <form>
                  ...
                  <div
                      className="container-fluid row g-3 d-flex align-items-center mt-4"
                      style={{
                          borderRadius: "15px",
                  ...
                  >
                      {/* Short Synopsis */}
                      <div
                          className="col-sm-12 col-md-8 my-4"
                  ...
                  >
                      ...
                      >
                          <div className="d-flex align-items-center justify-content-between mb-2">
                              <label className="text-xs">Medium Synopsis</label>
                                  <Button
            ...
            {characterLength?.text_medium}
                  ...
                  >
                      {/* Long Synopsis + Button */}
                          ...
                          >
                              <div className="d-flex align-items-center justify-content-between mb-2">
                                  <span className="text-sm font-normal">Long Synopsis</span>
