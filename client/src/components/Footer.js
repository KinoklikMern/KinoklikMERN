        ...
        <div class="row">
          ...
          <div class="col-md-2 px-4 py-3 footer-columns">
            <ul class="footer-ul">
              ...
              <li class="footer-li"><a href=""></a>Home</li>
              <li class="footer-li"><a href=""></a>Shows</li>
              <li class="footer-li"><a href=""></a>Our Story</li>
            </ul>
          </div>
          <div class="col-md-2 px-4 py-3 footer-columns">
            <ul class="footer-ul">
              ...
              <li class="footer-li"><a href=""></a>Terms of Service</li>
              <li class="footer-li"><a href=""></a>Privacy Policy</li>
              <li class="footer-li"><a href=""></a>More Legal Notices</li>
            </ul>
          </div>
          <div class="col-md-2 px-4 py-3 footer-columns">
            <ul class="footer-ul">
              ...
              <li class="footer-li"><a href=""></a>Customer Support</li>
              <li class="footer-li"><a href=""></a>press@kinoklik.ca</li>
            </ul>
          </div>
          <div class="col-md-2 px-4 py-3 footer-columns">
