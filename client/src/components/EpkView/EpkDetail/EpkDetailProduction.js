...
export default function EpkDetailProduction({ epkInfo, isEditMode, onChange, errors, clearError }) {
  ...
  return (
    <div className="tw-w-full tw-flex tw-flex-col tw-gap-6 tw-px-2 md:tw-px-0">
      <h2 className="tw-text-[#FF43A7] tw-text-[10px] tw-font-bold tw-uppercase tw-tracking-widest">{t('Technical Specs')}</h2>
      <h1 className="tw-text-white tw-text-3xl md:tw-text-4xl tw-font-bold tw-tracking-tight tw-mb-2">{t('Production Details')}</h1>
