...
export default function ActionPlaceholder({ 
  ...
  const variants = {
    ...
    resource: {
      wrapper: "tw-h-full",
      container: "tw-w-full tw-h-full tw-min-h-[350px] md:tw-min-h-[420px] tw-bg-[#280D41] tw-border-2 tw-border-dashed tw-border-[#FF43A7] tw-rounded-[32px] md:tw-rounded-[49px] hover:tw-bg-[#371E51]/50",
    ...
    photo: {
      wrapper: "tw-h-full",
      container: "tw-w-[140px] md:tw-w-[256px] tw-h-full tw-min-h-[210px] md:tw-min-h-[384px] tw-bg-[#FF43A7]/5 tw-border-2 tw-border-dashed tw-border-[#FF43A7]/40 tw-rounded-[12px] hover:tw-bg-[#FF43A7]/10",
    ...
    video: {
      wrapper: "tw-h-full",
      container: "tw-w-[260px] md:tw-w-[420px] tw-h-full tw-min-h-[146px] md:tw-min-h-[240px] tw-bg-[#FF43A7]/5 tw-border-2 tw-border-dashed tw-border-[#FF43A7]/40 tw-rounded-[16px] md:tw-rounded-[12px] hover:tw-bg-[#FF43A7]/10",
    ...
    crewCard: {
      wrapper: "tw-shrink-0 tw-w-[260px] md:tw-w-[280px] tw-p-[4px] tw-snap-center", 
      container: "tw-w-full tw-h-full tw-min-h-[400px] md:tw-min-h-[460px] tw-bg-transparent tw-border-2 tw-border-dashed tw-border-[#FF43A7]/40 tw-rounded-[38px] hover:tw-bg-white/5",
      ...
      iconSize: "tw-text-[20px] md:tw-text-[24px] tw-text-[#FF43A7]",
      iconType: faUserPlus,
      ...
      subtitleStyle: "tw-font-['Space_Grotesk'] tw-font-normal tw-text-[10px] tw-text-[#FF43A7] tw-tracking-[1px] tw-uppercase tw-mt-2"
    },
    castCard: {
      wrapper: "tw-shrink-0 tw-w-[260px] md:tw-w-[280px] tw-p-[4px] tw-snap-center", 
      container: "tw-w-full tw-h-full tw-min-h-[400px] md:tw-min-h-[460px] tw-bg-transparent tw-border-2 tw-border-dashed tw-border-[#FF43A7] tw-rounded-[38px] hover:tw-bg-[#FF43A7]/5", 
      iconWrapper: "tw-w-[56px] md:tw-w-[64px] tw-h-[56px] md:tw-h-[64px] tw-bg-[#FF43A7]/10 tw-rounded-full tw-transition-transform group-hover:tw-scale-110",
